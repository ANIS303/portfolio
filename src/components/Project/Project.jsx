        ...
        <div className="container py-5  ">
          <div className="row gap-2 g2 justify-content-center">
            ...
            <div className="col-md-3 ">
              <div className="card bg-transparent">
                <div className={styles.cardImage}>
                  <a
                    href="https://movies-anis303.vercel.app/"
                    target="_blank"
                    class="  ">
                    {" "}
                    <img src={movies} alt="" />
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Use:React Libraries(Framework) ,HTML,CSS, Bootstrap ,
                    java-script, Ajax .
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-3">
              <div className="card bg-transparent">
                <div className={styles.cardImage}>
                  <a href="https://anis-e-commerce.vercel.app" target="_blank">
                    <img src={market} alt="" />
                  </a>
                  <div className={styles.imgLayer}>
                    <a
                      href="https://anis-e-commerce.vercel.app"
                      target="_blank"
                      className="">
                      visit
                    </a>
            ...
            <div className="col-md-3">
              <div className="card bg-transparent">
                <div className={styles.cardImage}>
                  <a
                    href="https://maels-info.vercel.app/"
                    target="_blank"
                    class="">
                    <img src={food} alt="" />
                  </a>
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Use : HTML,CSS, Bootstrap, java-script,Ajax.{" "}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="card bg-transparent">
                <div className={styles.cardImage}>
                  <a
                    href="https://games-red-six.vercel.app"
                    target="_blank"
                    className="">
                    {" "}
                    <img src={games} alt="" />
            ...
            <div className="col-md-3">
              <div className="card bg-transparent">
                <div className={styles.cardImage}>
                  <a
                    href="https://crud-anis303.vercel.app"
                    target="_blank"
                    class="">
                    {" "}
                    <img src={crud} alt="" />
            ...
            <div className="col-md-3">
              <div className="card bg-transparent">
                <div className={styles.cardImage}>
                  <a
                    href="https://todolist-ts-rho.vercel.app"
                    target="_blank"
                    class="">
                    {" "}
                    <img src={todo} alt="" />
